...
$this->registerCssFile('@web/css/stylehome_ar.css', ['depends' => [yii\web\YiiAsset::class]]);
?>
            ...
            <div class="row col-md-12 mb-5" style="border: 1px solid lightgray;">
                <div class="col-md-2 p-2 ">
                    <div class="icon ">
                        <div class="overlap-group"  >
                            <div class="rectangle-3 mr-3"></div>
                    <img class="icon-1 mr-3" style="width: 100%;"  src="<?= Yii::getAlias('@web') . '/uploads/' . $product->iconName?>" alt="Icon" />
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-10">
                    <div class="text col-md-12 ">
                        <div class="div">
                            <div class="text-wrapper"><?= Html::encode($product->title_ar) ?></div>
                            <p class="text-wrapper-2"><?= Html::encode($product->category->name_ar) ?></p>
                        </div>
                        <div class="row col-md-12" >
                            ...
                            <div class="price-button col-md-5 row">
                                ...
                                <div class="price col-md-6 ">
                                    <div class="cash-price ml-0">
                                        <div class="price-2 ml-0">
                                            <div class="text-wrapper-4">الضمان</div>
                                            <div class="number">
                                                <div class="text-wrapper-5"><?= Html::encode($product->warranty) ?> سنوات</div>
                                    ...
                                    <div class="cash-price-2  ml-0">
                                        ...
                                        <div class="price-2">
                                            <div class="text-wrapper-4">سعر الخدمة</div>
                                            <div class="number">
                                                
                                                <div class="text-wrapper-7"><?= Html::encode($product->price) ?></div>

                                                <div class="text-wrapper-6">ريال</div>
                                            </div>
                                ...
                                <div class="text-icon">
                                    <div class="text-wrapper-3">طلب شراء خدمة</div>
                                </div>
                            </div>
                            </div>
